...
export default defineCommand({
  ...
  action: async (options) => {
    ...
    console.log(chalk.cyan('  hefs hi          ') + chalk.gray('Say hello with style'));
    console.log(chalk.cyan('  hefs deploy      ') + chalk.gray('Deploy your application'));
    console.log(chalk.cyan('  hefs config      ') + chalk.gray('Manage configuration'));
